...
In many cases, it may be desireable to incorporate seasonal variation in demography as well as separating mating from birth.
This can be done by letting the user specify individual transition events (including some, such as birth, that don't have a duration), and using the theory of periodic models to assemble them into annual models.
